  ...
  <React.StrictMode>
    <BrowserRouter>
        <Routes>
          ...
          <Route path='/logout' Component={Logout} element={<><NavbarConsumer /> <Logout /></>} />
          <Route path='/signup' element={<><NavbarConsumer /> <Signup /></>} />
          <Route path='/forgot-password' element={<><NavbarConsumer /> <ForgetPassword /></>} />
          <Route path='/product'element={<><NavbarConsumer /> <DataProvider endpoint={"api/product/"} render={data => <Product data={data}/>} /></>} />
